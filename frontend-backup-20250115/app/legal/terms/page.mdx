...
By accessing and using ProfitPad ("the Service"), you accept and agree to be bound by the terms and provision of this agreement.

## Description of Service

ProfitPad is a trading journal platform that provides:
...
### Permitted Uses
- Personal trading journal and analysis
