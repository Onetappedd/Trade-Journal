...
INSERT INTO public.import_mapping_presets (user_id, name, broker_hint, file_glob, fields) VALUES
  ...
  ('00000000-0000-0000-0000-000000000000', 'Webull Options', 'webull', '*options*.csv', '{"timestamp": "Filled Time", "symbol": "Name", "side": "Side", "quantity": "Filled", "price": "Avg Price", "fees": "Fees", "currency": "USD", "venue": "NASDAQ", "instrument_type": "option", "multiplier": "100"}'),
