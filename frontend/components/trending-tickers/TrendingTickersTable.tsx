...
const mockData = {
  stocks: [
    { symbol: "AAPL", name: "Apple Inc.", price: 175.43, change: 2.15, volume: "45.2M", marketCap: "2.75T" },
    {
      symbol: "MSFT",
    ...
    { symbol: "GOOGL", name: "Alphabet Inc.", price: 142.56, change: 3.45, volume: "28.7M", marketCap: "1.78T" },
    { symbol: "AMZN", name: "Amazon.com Inc.", price: 145.86, change: -0.87, volume: "41.3M", marketCap: "1.51T" },
    { symbol: "TSLA", name: "Tesla Inc.", price: 248.42, change: 5.67, volume: "67.8M", marketCap: "789.2B" },
  ],
  etfs: [
    { symbol: "SPY", name: "SPDR S&P 500 ETF", price: 445.67, change: 1.23, volume: "78.5M", marketCap: "412.3B" },
    { symbol: "QQQ", name: "Invesco QQQ Trust", price: 378.92, change: 2.45, volume: "45.2M", marketCap: "198.7B" },
    {
      symbol: "VTI",
  ...
  crypto: [
    { symbol: "BTC", name: "Bitcoin", price: 43250.75, change: 3.45, volume: "2.1B", marketCap: "847.2B" },
    { symbol: "ETH", name: "Ethereum", price: 2567.89, change: -1.87, volume: "1.8B", marketCap: "308.5B" },
    { symbol: "ADA", name: "Cardano", price: 0.4523, change: 5.67, volume: "456.7M", marketCap: "15.9B" },
  ],
}
                      ...
                      <TableCell colSpan={8} className="p-4 bg-muted/20">
                        <div className="flex items-center justify-center h-32 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-950/20 dark:to-green-950/20 rounded-lg">
                          <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground">Chart for {item.symbol} would go here</p>
                          </div>
                        </div>
                      </TableCell>
                    </TableRow>
