...
export function DashboardStats({ stats }: DashboardStatsProps) {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: portfolioData ? portfolioData.positions.length.toString() : stats.activePositions.toString(),
      change: portfolioData && portfolioData.positions.length > 0 
        ? `${portfolioData.positions.length} open` 
        : stats.activePositions > 0 ? "Open" : "No positions",
