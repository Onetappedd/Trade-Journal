...
const GoogleIcon = () => (
  <svg className="h-5 w-5 mr-2" viewBox="0 0 48 48">
    <g>
      <path
        fill="#4285F4"
        d="M24 9.5c3.54 0 6.36 1.53 7.82 2.81l5.77-5.77C34.64 3.36 29.74 1 24 1 14.82 1 6.88 6.98 3.44 15.09l6.91 5.36C12.13 14.09 17.62 9.5 24 9.5z"
      />
      <path
        fill="#34A853"
        d="M46.1 24.55c0-1.64-.15-3.21-.43-4.73H24v9.01h12.42c-.54 2.9-2.18 5.36-4.65 7.01l7.19 5.6C43.98 37.36 46.1 31.45 46.1 24.55z"
      />
      <path
        fill="#FBBC05"
        d="M10.35 28.45c-1.04-3.09-1.04-6.41 0-9.5l-6.91-5.36C.99 17.36 0 20.57 0 24c0 3.43.99 6.64 3.44 9.41l6.91-5.36z"
      />
      <path
        fill="#EA4335"
        d="M24 46.5c5.74 0 10.54-1.89 14.06-5.14l-7.19-5.6c-2.01 1.35-4.59 2.14-7.37 2.14-6.38 0-11.87-4.59-13.65-10.86l-6.91 5.36C6.88 41.02 14.82 46.5 24 46.5z"
      />
