...
import { Home, TrendingUp, BarChart3, Activity, Calculator, Settings, Plus, Upload, FileText, X } from "lucide-react"
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-neutral-800">
          ...
          <Button variant="ghost" size="icon" className="lg:hidden text-neutral-400 hover:text-white" onClick={onClose}>
            <X className="h-5 w-5" />
          </Button>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-blue-600 text-white" : "text-neutral-300 hover:bg-neutral-800 hover:text-white",
                  )}
                  onClick={onClose}
                >
          ...
          {/* Quick Actions */}
          <div className="pt-6">
            <h3 className="px-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-3">Quick Actions</h3>
            <div className="space-y-1">
