  ...
  const getColorClass = (pnl: number, isCurrentMonth: boolean = false) => {
    if (pnl > 0) {
      ...
      return cn(
        ...
        pnl <= 500 && "bg-green-100 hover:bg-green-200 dark:bg-green-950/50 dark:hover:bg-green-900/50",
        pnl > 500 && pnl <= 2000 && "bg-green-200 hover:bg-green-300 dark:bg-green-900/60 dark:hover:bg-green-800/60",
        pnl > 2000 && pnl <= 5000 && "bg-green-300 hover:bg-green-400 dark:bg-green-800/70 dark:hover:bg-green-700/70",
        pnl > 5000 && "bg-green-400 hover:bg-green-500 dark:bg-green-700/80 dark:hover:bg-green-600/80",
      ...
      return cn(
        ...
        pnl < -500 && pnl >= -2000 && "bg-red-200 hover:bg-red-300 dark:bg-red-900/60 dark:hover:bg-red-800/60",
        pnl < -2000 && pnl >= -5000 && "bg-red-300 hover:bg-red-400 dark:bg-red-800/70 dark:hover:bg-red-700/70",
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Year-at-a-glance profit and loss by month
            </CardDescription>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg font-semibold text-green-600">
                {yearStats.bestMonth.month.substring(0, 3)}: {formatCurrency(yearStats.bestMonth.realizedPnL)}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">Worst Month</p>
              <p className="text-lg font-semibold text-red-600">
                {yearStats.worstMonth.month.substring(0, 3)}: {formatCurrency(yearStats.worstMonth.realizedPnL)}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">Win Rate</p>
              <p className="text-lg font-semibold">
                {yearStats.profitableMonths}/{yearStats.profitableMonths + yearStats.losingMonths} months
              </p>
            </div>
          </div>
                          ...
                          <>
                            <div className="space-y-1 text-sm">
                              <div className="flex justify-between">
                                ...
                                <span className={month.realizedPnL >= 0 ? "text-green-600" : "text-red-600"}>
                              ...
                              {month.unrealizedPnL !== 0 && (
                                <div className="flex justify-between">
                                  ...
                                  <span className={month.unrealizedPnL >= 0 ? "text-green-600" : "text-red-600"}>
                              ...
                              <div className="flex justify-between font-semibold pt-1 border-t">
                                <span>Total:</span>
                                <span className={month.totalPnL >= 0 ? "text-green-600" : "text-red-600"}>
