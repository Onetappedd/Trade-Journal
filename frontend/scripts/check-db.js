...
const REQUIRED_TABLES = {
  trades: [
    'id','user_id','symbol','asset_type','side','quantity','entry_price','exit_price','entry_date','exit_date','status','notes',
    'strike_price','expiry_date','option_type', // options
    'contract_code','point_multiplier','tick_size','tick_value', // futures
