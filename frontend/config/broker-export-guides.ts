...
export const BROKER_EXPORT_GUIDES: Record<string, BrokerGuide> = {
  ibkr: {
    ...
    steps: [
      ...
      { title: "Period/Date Range", detail: "Select your desired statement period or a custom date range." },
      { title: "Generate → Download CSV (Trades)", detail: "Generate the report and download the CSV for the Trades section." },
    ],
    notes: [
  ...
  schwab: {
    ...
    steps: [
      ...
      { title: "Transactions", detail: "Filter by Transactions and set your desired date range/type." },
  ...
  webull: {
    ...
    steps: [
      ...
      { title: "Statements → Trade Confirmations / Account", detail: "Locate statements and trade confirmations." },
  ...
  robinhood: {
    ...
    steps: [
      { title: "Account → Statements & History", detail: "Open your account and go to Statements & History." },
  ...
  fidelity: {
    ...
    steps: [
      { title: "Accounts → Activity & Orders", detail: "Open your account and navigate to Activity & Orders." },
  ...
  coinbase: {
    ...
    steps: [
      ...
      { title: "Transaction History / Fills", detail: "Select the transaction history or fills view." },
  ...
  kraken: {
    ...
    steps: [
      ...
      { title: "Transaction History / Fills", detail: "Select the fills or transaction history view." },
  ...
  generic: {
    ...
    steps: [
      ...
      { title: "Find Statements / History", detail: "Open the statements, history, or activity section." },
