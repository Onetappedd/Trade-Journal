...
// Shared filters type for trade history UI
export type TradeFilters = Record<string, any>;
export type FiltersSetter = React.Dispatch<React.SetStateAction<TradeFilters>>;