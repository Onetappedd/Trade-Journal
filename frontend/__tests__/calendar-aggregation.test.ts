    ...
    const trades: T[] = [
      {
        ...
        exit_date: '2024-01-05T10:00:00Z',
        status: 'closed',
      },
      {
        id: '2',
        ...
        exit_date: '2024-01-05T15:00:00Z',
        status: 'closed',
      },
    ];
    ...
    const trades: T[] = [
      {
        ...
        exit_date: '2024-02-01T01:00:00Z',
        status: 'closed',
      },
      {
        id: '2',
        ...
        exit_date: '2024-02-28T22:00:00Z',
        status: 'closed',
      },
    ];
    const daily = aggregateRealized(trades);
    ...
    const trades: T[] = [
      {
        ...
        exit_price: 110,
        entry_date: '2024-01-01',
        exit_date: new Date('2024-01-05T23:30:00').toISOString(),
        status: 'closed',
      },
      {
        id: '2',
        ...
        exit_price: 120,
        entry_date: '2024-01-01',
        exit_date: new Date('2024-01-05T00:30:00').toISOString(),
        status: 'closed',
      },
    ];
    const daily = aggregateRealized(trades);
