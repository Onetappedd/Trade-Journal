...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showError("Reset Failed", "Unable to send reset email. Please try again.")
    } finally {
  ...
  const handleResendEmail = async () => {
    ...
    try {
      ...
      showSuccess("Email Resent", "Password reset email has been sent again.")
    } catch (error) {
      showError("Resend Failed", "Unable to resend email. Please try again.")
    } finally {
      setIsSubmitting(false)
    }
  }
