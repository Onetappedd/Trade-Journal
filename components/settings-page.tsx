        ...
        <TabsContent value="profile" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure your trading-related settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="defaultStrategy">Default Trading Strategy</Label>
        ...
        <TabsContent value="data" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Export or delete your trading data</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Download all your trading data in various formats
                  </p>
